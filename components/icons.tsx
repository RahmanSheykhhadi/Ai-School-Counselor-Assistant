...
export const AppLogoIcon: React.FC<AppLogoIconProps> = ({ iconUrl, ...props }) => {
    if (iconUrl) {
        return <img src={iconUrl} alt="App Logo" {...props} />;
    }
    return null;
};
...
export const UsersIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm6-11.828a4 4 0 11-5.292 0 4 4 0 015.292 0zM21 21v-1a6 6 0 00-9-5.197" />
  </svg>
);
